...
$scope.toggleDescription=function(isAreaClick){if($scope.clip.source_url&&isAreaClick&&!document.body.classList.contains('desc-open')){$scope.openFeed($scope.clip.nid,$scope.clip.is_ebay)}
